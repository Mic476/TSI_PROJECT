                ...
                <li class="nav-item dropdown d-flex align-items-center">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="myprofile">
                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md text-primary" href="javascript:;"
                                    id="toggleSidenavFromProfile">
                                    <i class="fa fa-bars pe-2"></i>
                                    <span class="font-weight-bold" id="toggleSidenavText">Hide Menu</span>
                                </a>
                            </li>
                            <li class="mb-2">
