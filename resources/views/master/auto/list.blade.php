            ...
            <div class="col-md-12">
                <div class="row mx-1">
                    <div class="card">
                        ...
                        <div class="row px-4 py-2" style="min-height: 300px;">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($table_detail as $detail)
                                            @php
                                                ...
                                                $rowIsActive = $detail->isactive ?? $detail->is_active ?? '1';
                                            @endphp
                                            <tr
                                                {{ $rowIsActive == '0' ? 'class=not style=background-color:#ffe9ed;' : '' }}>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            @if ($authorize->delete == '1' && $primary != 'msjit')
                                                                <form
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-sm btn-{{ $rowIsActive == '0' ? 'success' : 'danger' }} mx-2 mb-0 w-90"
                                                                        title="Hapus Data"
                                                                        onclick="return deleteData(event, '{{ $primary }}','{{ $rowIsActive == '0' ? 'Aktifkan' : 'Non Aktifkan' }}')">
                                                                        <i class="fas fa-random"></i><span
                                                                            class="font-weight-bold">
                                                                            {{ $rowIsActive == '0' ? 'Aktifkan' : 'Non Aktifkan' }}</span>
                                                                    </button>
                                                                </form>
                                                            @endif
                                                            <li>
