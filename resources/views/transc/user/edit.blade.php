            ...
            <div class="row gx-4">
                <div class="col-lg">
                    <div class="nav-wrapper">
                        <button class="btn btn-secondary mb-0" onclick="history.back()"><i class="fas fa-circle-left me-1"></i><span class="font-weight-bold">Kembali</span></button>
                        @if ($authorize->edit == '1')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    ...
                                    <p class="text-xs text-secondary mt-2 mb-0">Draft dapat diedit sebelum dikonfirmasi.</p>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-12">
